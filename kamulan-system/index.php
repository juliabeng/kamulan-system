...
">
  ...
  <nav class="nav-links" style="display:flex; gap:12px;">
    <a href="/kamulan-system/auth/register.php" class="btn" style="
      ...
      font-weight:500;
    " onmouseover="this.style.background='#cde0a8';" onmouseout="this.style.background='#a2b67e';">Register</a>
    ...
    <a href="/kamulan-system/auth/login.php" class="btn" style="
      ...
      transition:all 0.3s ease;
      font-weight:500;
    " onmouseover="this.style.background='#cde0a8';" onmouseout="this.style.background='#a2b67e';">Login</a>
...
<main class="landing">
  ...
  <section class="top-controls" style="display:flex; justify-content:space-between; align-items:center; gap:20px; flex-wrap:wrap; margin:20px;">
    ...
    <div class="search-bar" style="display:flex; align-items:center; gap:8px; margin-left: 508px;">
      <input type="text" placeholder="Search menu..." style="padding:8px; border-radius:6px; border:1px solid #ccc;">
      <button style="padding:8px 12px; background:#6b7b44; color:white; border:none; border-radius:6px; cursor:pointer;">🔍︎</button>
    </div>
  </section>
  ...
  <section id="menuSection" class="content-section">
    ...
    <section style="display:flex; justify-content:center; align-items:center; flex-direction:column; padding:40px 20px; text-align:center;">
      <div class="about" style="max-width:700px;">
        ...
        <p style="font-size:1.05rem; line-height:1.6; color:#333; text-align: center;">
...
<section id="storesSection" class="content-section hidden" 
         style="background-color: #556B2F; border-radius: 18px; padding: 60px 20px; text-align: center;">
  <h2 style="color: #f5f5f5; margin-bottom: 40px; font-size: 2rem; letter-spacing: 1px;">
    Our Branches
  </h2>
  ...
  <div class="branch-grid" 
    ...
    <div class="branch-card" 
         style="background: #fff; border-radius: 15px; box-shadow: 0 4px 10px rgba(0,0,0,0.2); width: 300px; padding: 20px;">
      <img src="/kamulan-system/assets/images/branches/rizal.jpg" alt="Rizal" 
           style="width: 100%; border-radius: 10px; margin-bottom: 15px;">
      <h3 style="color: #556B2F;">Kamulan – Rizal, Laguna</h3>
      <p style="color: #333;">📍 Rizal, Laguna<br>☎ 0970-401-1952</p>
      <a href="/kamulan-system/auth/register.php" 
         class="btn" 
         style="display: inline-block; background: #6b7b44; color: #fff; padding: 10px 20px; border-radius: 8px; text-decoration: none; margin-top: 10px;">
         Order Now
      </a>
    </div>
    ...
    <div class="branch-card" 
      ...
      <img src="/kamulan-system/assets/images/branches/zulueta.jpg" alt="Zulueta" 
           style="width: 100%; border-radius: 10px; margin-bottom: 15px;">
      <h3 style="color: #556B2F;">Kamulan – San Pablo City (P. Zulueta)</h3>
      <p style="color: #333;">📍 P. Zulueta St., San Pablo City<br>☎ 0950-188-8568</p>
      <a href="/kamulan-system/auth/register.php" 
         class="btn" 
         style="display: inline-block; background: #6b7b44; color: #fff; padding: 10px 20px; border-radius: 8px; text-decoration: none; margin-top: 10px;">
         Order Now
    ...
    <div class="branch-card" 
      ...
      <img src="/kamulan-system/assets/images/branches/mabini.jpg" alt="Mabini" 
           style="width: 100%; border-radius: 10px; margin-bottom: 15px;">
      <h3 style="color: #556B2F;">Kamulan – San Pablo City (A. Mabini)</h3>
      <p style="color: #333;">📍 A. Mabini St., San Pablo City<br>☎ 0992-622-5396</p>
      <a href="/kamulan-system/auth/register.php" 
         class="btn" 
         style="display: inline-block; background: #6b7b44; color: #fff; padding: 10px 20px; border-radius: 8px; text-decoration: none; margin-top: 10px;">
         Order Now
